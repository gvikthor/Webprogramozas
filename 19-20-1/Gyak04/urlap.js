...
$('urlap').helyszin[0].addEventListener('click', () => { // férfi
    $('helyszin_inputok').innerHTML = '1. helyszín: <input type="text" id="helyszin_0"><br>';
});
$('urlap').helyszin[1].addEventListener('click', () => { // férfi
    $('helyszin_inputok').innerHTML = '1. helyszín: <input type="text" id="helyszin_0"><br>2. helyszín: <input type="text" id="helyszin_1"><br>';
});
$('urlap').helyszin[2].addEventListener('click', () => { // férfi
    $('helyszin_inputok').innerHTML = '1. helyszín: <input type="text" id="helyszin_0"><br>2. helyszín: <input type="text" id="helyszin_1"><br>3. helyszín: <input type="text" id="helyszin_2"><br>';
});
