<?php function page_auth_login(){ ?>
    ...
    <form method="POST" action="query/login.php">
        ...
        <input name="pword" placeholder="Password"> <br>
...
<?php function page_auth_register(){ ?>
    <h2>Register</h2>
    <form method="POST" action="query/register_clean.php">
        Username:<br>
        <input name="uname" placeholder="Username"> <br>
        Password: <br>
        <input name="pword1" placeholder="Password"> <br>
        Password again: <br>
        <input name="pword2" placeholder="Password"> <br>
        Age: <br>
